...
# Results - return every word in the string replaced by sex (except empty string which returns empty)
# Example - 'hello world' -> 'sex sex'
# Pseudocode:
#   return empty string if given empty
#   iterate over string
#       replace words with string 'sex'

# didn't solve - see my favorite solution here:
