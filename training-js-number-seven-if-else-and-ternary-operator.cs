...
// Parameters - receive one integer which is the number of hotdogs a customer will buy
// Results - calculate cost of hot dogs based on how many customer is buying
// Example - 1 -> 1 * 100 = 100
// Pseudocode:
// 	if n < 5
// 		return 100 * n
