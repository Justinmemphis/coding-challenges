...
// Parameters - receive price, discount %, and cost of holiday
// Results - return how much you need to meet the cost of the holiday
// Example - see above
// Pseudocode:
// 	return holiday / (cost * discount)

public class Kata
{
  public static int DutyFree(int normPrice, int Discount, int hol)
  {
    double discountedPrice = normPrice * (Discount / 100.00);
    return (int)(hol / discountedPrice);
