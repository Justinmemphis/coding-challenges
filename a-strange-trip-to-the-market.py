...
# Results - return true if string contains 'tree fiddy'
# Example - n/a
# Pseudocode - return true if string contains 'tree fiddy'

def is_loch_ness_monster(string):
    matches = ['tree fiddy', '3.50', 'three fifty']
    return any(x in string for x in matches)
