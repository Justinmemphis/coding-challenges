...
// Results - if the integer squared is more than 1000 return one string; else return another string
// Example - see above
// Pseudocode:
// 	return result * result > 1000 ? string one : string two
...
public class Kata
{
	public static string Apple(object n)
	{
		...
		return result * result > 1000 ? "It's hotter than the sun!!" : "Help yourself to a honeycomb Yorkie for the glovebox.";
	}
}
